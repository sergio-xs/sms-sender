                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Përshëndetje {{ $name }}!</p>
                                        <p style="margin: 0 0 24px;">
                                             Keni dërguar një kërkesë për të ndryshuar fjalëkalimin e llogarisë tuaj
                                            <span style="font-weight: 600;">{{config('app.name')}}</span>
                                            <a href="#" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">{{$email}}</a>
                                        </p>
                                        <p style="margin: 0 0 24px;">Klikoni butonin 'Ndrysho fjalëkalimin &rarr;' për të ndryshuar fjalëkalimin
                                            dhe për tu loguar.</p>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                                                    ...
                                                    <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                        ...
                                                        <a href="{{ $url }}"
                                                           style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;border-radius: 4px">
                                                            Ndrysho fjalëkalimin &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <p style="margin: 24px 0;">
                                                <span style="font-weight: 600;">Kujdes:</span>
                                                Ky mundësi vlen vetëm për një orë që nga koha që ju është
                                                dërguar email dhe mund të përdoret për të ndryshuar fjalëkalimin tuaj vetëm
                                                një herë.
                                            </p>
                                            ...
                                            <p style="margin: 0 0 16px;">Faleminderit , <br>{{config('app.name')}}</p>
                                            </td>
                                            </tr>
                                            <tr>
